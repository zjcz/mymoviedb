...
import 'package:mymoviedb/extensions/color_utils.dart';
...
void main() {
  group('ColorUtils', () {
    ...
    test('toInt converts Color with transparency to int correctly', () {
      const color =
          Color.fromARGB(128, 0, 255, 0); // Semi-transparent green color
      final colorInt = color.toInt();
    ...
    test('toInt converts Color with full transparency to int correctly', () {
      const color =
          Color.fromARGB(0, 255, 255, 255); // Fully transparent white color
      final colorInt = color.toInt();
